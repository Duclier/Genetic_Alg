class Individual {
  constructor(DNA) {
     ...
     this.allAcc = []
     this.problem = false;
     //this.out_canvas = false;
     //this.colide_obtc = false;
  }
  calcFit() {
    ...
    this.fitness = (1/Math.sqrt(par1 + par2))*this.alfa;
    return this.fitness;
  }
  update() {
    ...
    if(this.move){
      ...
      this.pos.y += this.vel.y; // apl * 2ica a movimentação no objeto, no eixo y
